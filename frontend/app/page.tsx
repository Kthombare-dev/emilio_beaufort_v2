    ...
    <div className="min-h-screen bg-premium">
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-premium">
        ...
        >
          ...
          >
            Experience the elegance of Emilio Beaufort—where ethical temple hair meets luxury extensions. 
            Handcrafted for timeless beauty, trusted worldwide. Begin your transformation today.
          </motion.p>
          ...
          >
            <Button
              size="lg"
              aria-label="Discover the Emilio Beaufort Philosophy"
              className="px-12 py-6 text-lg font-sans-medium transition-all duration-300 bg-black/80 text-white hover:bg-white hover:text-black border border-white backdrop-blur-sm hover:backdrop-blur-md hover:shadow-2xl hover:shadow-white/20 relative z-50"
              onClick={() => {
                document.getElementById('philosophy')?.scrollIntoView({ behavior: 'smooth' });
                trackEngagement.buttonClick('Discover the Emilio Beaufort Philosophy', 'hero-section');
              }}
              style={{
            ...
            >
              Discover the Emilio Beaufort Philosophy
            </Button>
          </motion.div>
      ...
      >
        ...
        >
          <span className="relative inline-block">
            {/* Full heading kept together for SEO */}
            <motion.span
